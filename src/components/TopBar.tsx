...
function LocaleButton({ locale, isActive, onClick }: { locale: (typeof locales)[number]; isActive: boolean; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
    ...
    <div className="bg-blue-900 text-white font-secondary text-[0.85rem]">
      <div className="flex items-center justify-between px-6 lg:px-20 py-3">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="tel:+212522319695" className="flex items-center gap-2 hover:text-white transition-colors">
            <Phone size={16} /> 05 22 31 96 95
          </a>
          <a href="mailto:hammamziani@yahoo.com" className="flex items-center gap-2 hover:text-white transition-colors">
